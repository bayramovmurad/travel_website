...
const Footer = () => {
  ...
  return (
    <div>
      <div className="h-[250px] lg:h-[450px]"></div>
      <footer className="relative  bg-black text-white">
        <div
          className="absolute -top-52 left-1/2 transform -translate-x-1/2 
       ...
       grid grid-cols-1 md:grid-cols-2 items-center gap-6">
        ...
        <div className="container mx-auto relative py-32 px-4 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-7 gap-8">
          <div className="lg:col-span-2">
            ...
            <p className="mt-4 text-sm">
              ...
              consectetur omnis ullam iure tempore ab doloremque neque
              repellendus enim, dolore ratione error, corrupti consequatur
              nesciunt.
            </p>
        ...
        <div className="container mx-auto py-4 text-center text-sm border-t border-gray-700">
          <div className="flex flex-col md:flex-row justify-between">
            ...
            <div>
              <span className="text-orange-500">Media</span> Bayramov Media
            </div>
          </div>
        </div>
      </footer>
